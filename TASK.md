...
* **Формирует на выходе:**
  * Список проверяемых гипотез (например: «добавка 0.3% ниобия в сплав X при режиме отжига Y повысит жаропрочность за счёт формирования дисперсных карбидов»)
...
* Оценка неопределенности и рекомендации по верификации
